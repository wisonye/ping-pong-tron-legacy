...
Rectangle Table_redraw(const Game *game, const Rectangle *sb_rect) {
    ...
    if (game->state == GS_BEFORE_START) {
        ...
        Vector2 start_prompt_font_size =
            MeasureTextEx(font,
                          TABLE_UI_FIRST_START_PROMPT_TEXT,
        ...
        DrawRectangleLinesEx(start_prompt_rect,
                             TABLE_UI_BORDER_THICKNESS,
    ...
    //
        ...
        snprintf(last_winner_name,
                 sizeof(last_winner_name),
                 "%s%s",
        ...
        Vector2 restart_font_size =
            MeasureTextEx(font,
                          TABLE_UI_PLAYER_WINS_RESTART_TEXT,
        ...
        DrawRectangleLinesEx(wins_prompt_rect,
                             TABLE_UI_BORDER_THICKNESS,
