...
///
///
void draw_player_name_and_score(const char *name,
                                usize score,
                                bool is_player_1,
                                const Font *font,
    ...
    // Name
    //
    Vector2 name_font_size = MeasureTextEx(*font,
                                           name,
                                           SCOREBOARD_UI_PLAYER_NAME_FONT_SIZE,
...
Rectangle SB_redraw(const Scoreboard *sb) {
    ...
    DrawRectangleLinesEx(rect,
                         SCOREBOARD_UI_BORDER_THICKNESS,
    ...
    Vector2 vs_font_size = MeasureTextEx(font,
                                         "VS",
                                         SCOREBOARD_UI_VS_FONT_SIZE,
    ...
    // Player
    //
    draw_player_name_and_score(sb->player1->name,
                               sb->player1->score,
                               true,
                               &font,
                               &rect,
                               SCOREBOARD_UI_BORDER_COLOR);
    draw_player_name_and_score(sb->player2->name,
                               sb->player2->score,
                               false,
                               &font,
                               &rect,
